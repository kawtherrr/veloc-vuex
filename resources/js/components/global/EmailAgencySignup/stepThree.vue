<template>
    ...
    <div class="flex flex-col items-center">
        ...
        <div class="flex flex-col mb-3">
            ...
            <p v-if="errors3.wilaya" class="text-red-600  mb-2">{{ errors3.wilaya }} </p>
        ...
        <div class="flex flex-col mb-3">
            ...
            <p v-if="errors3.city" class="text-red-600 mb-2">{{ errors3.city }} </p>
        ...
        <div class="flex flex-col mb-3">
            ...
            <p v-if="errors3.agency_address" class="text-red-600  mb-2">{{ errors3.agency_address }} </p>
        </div>
        ...
        <div class="flex flex-col mb-4">
            ...
            <input type="text" placeholder="Add your Phone number" class="-mt-2 px-9 py-2 font-light"
                style="border: 1px solid #BDBEBD; border-radius: 10px;width:350px" :value="phone"
                @input="$emit('update:phone', $event.target.value)">
            <p v-if="errors3.phone" class="text-red-600  mb-2">{{ errors3.phone }} </p>
        </div>
...
export default {
    ...
    methods: {
        ...
        async selectState(state) {
            ...
            try {
                const res2 = await axios.get("http://127.0.0.1:8000/api/cities/" + state.wilaya_name)
                console.log(res2)
