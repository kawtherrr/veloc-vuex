        ...
        <div class="calendar mx-2">
            ...
            <div class="days cursor-pointer">
                ...
                <div class="day" v-for="(day, i) in days" :key="i"
                    ...
                    :style="(this.currentYear + ':' + this.currentMonth + ':' + day) && pickupDate.includes(this.currentYear + ':' + this.currentMonth + ':' + day) ? 'background-color:#fdc100; color:white' : ''">
                    {{ day }}
                </div>
            ...
            <div class="m-2 max-h-36 overflow-y-auto">
                ...
                <div v-if="showRendezvous">
                    <div class="flex flex-row py-3 justify-center items-center" @click="showRenterDetails(day)"
                        ...
                        <div class="text-white bg-fdc100 py-2 w-80 flex justify-center cursor-pointer">
                            {{ day.renter }}
                        </div>
                    </div>
                </div>
        ...
        <div v-if="showRendezvousDetails" class="popup" align="center">
            <div class="popup-content flex flex-col justify-center items-center rounded-[21px] shadow-lg">
                <div class="flex flex-col">
                    <h1 class="text-black text-xl font-semibold">Pickup Time</h1>
                    <div class="flex flex-col items-start my-4">
                        <div class="py-1 text-lg">
                            <img src="/images/person-icon.svg" class="inline-block mr-2 w-6">
                            {{ rendezvousDetails.renter }}
                        </div>
                        <div class="py-2 text-lg">
                            <img src="/images/coche-icon.svg" class="inline-block mr-2 w-6">
                            {{ rendezvousDetails.car }}
                        </div>
                        <div class="py-2 text-lg">
                            <img src="/images/clock-yw.svg" class="inline-block mr-2 w-6">
                            {{ rendezvousDetails.time }}
                        </div>
                        <div class="py-1 text-lg">
                            <img src="/images/return-icon.svg" class="inline-block mr-2 w-6">
                            Returne Day :{{ rendezvousDetails.day }}
                        </div>
                    </div>
                </div>
                <button class="bg-fdc100 text-white px-4 py-2 rounded-xl text-lg" @click="closeDetailsPopup">Done</button>
            </div>
        </div>
    </div>
</template>
