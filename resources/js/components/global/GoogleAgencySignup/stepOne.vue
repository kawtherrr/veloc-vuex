<template>
    ...
    <div class="flex flex-col items-center">
        <div class="flex flex-col mb-4">
            ...
            <p v-if="errors4.name" class="text-red-600  mb-2">{{ errors4.name }} </p>
        </div>

        <div hidden>
            <input class="form-control mb-2" :value="email" @input="$emit('update:email', $event.target.value)" type="text">

            <input class="form-control mb-2" :value="google_id" @input="$emit('update:google_id', $event.target.value)"
                type="text">
        ...
        <div class="flex flex-col mb-4">
            ...
            <p v-if="errors4.agency_name" class="text-red-600  mb-2">{{ errors4.agency_name }} </p>
        </div>
        ...
        <div class="flex flex-col mb-4">
            ...
            <p v-if="errors4.car_models" class="text-red-600 mb-2">{{ errors4.car_models }} </p>
        </div>
        ...
        <div class="flex flex-col mb-4">
            ...
            <div class="relative -mt-2">
                <div @click="toggleSelectors" class="toggle-button font-normal pl-10 py-2 text-gray-400"
                    style="width:350px; overflow-y: hidden;"
            ...
            <p v-if="errors4.working_days" class="text-red-600  mb-2">{{ errors4.working_days }} </p>
            <p v-if="errors4.opening_hour" class="text-red-600  mb-2">{{ errors4.opening_hour }} </p>
            <p v-if="errors4.closing_hour" class="text-red-600  mb-2">{{ errors4.closing_hour }} </p>
        </div>
...
export default {
    ...
    emits: ['update:car_models', 'update:agency_name', 'update:name', 'update:email',
        'update:google_id', 'update:working_days', 'update:openHour', 'update:closeHour'],
